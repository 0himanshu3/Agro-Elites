      ...
      <div className="form p-8">
        ...
        <form action="#">
          ...
          <input 
            ...
            className="h-16 w-full px-4 text-lg mb-5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500"
          />
          <a href="#" className="text-teal-600 text-lg hover:underline">Forgot password?</a>
          <input 
            type="button" 
            className="button bg-teal-600 text-white text-lg font-medium mt-7 cursor-pointer transition-colors duration-300 hover:bg-teal-700 h-16 w-full rounded-lg" 
            value="Login"
          />
        </form>
      </div>
