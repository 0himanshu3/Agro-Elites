...
function MiniCard(props) {
    ...
    return (
        <div className="mini-card flex items-center p-3 mb-4 border rounded-lg shadow-md bg-green-300">
            ...
            <div className="mini-card-info ml-4 flex flex-col">
                ...
                <p className="mini-card-date text-sm text-gray-600">Published at: {props.publishedAt}</p>
            </div>
        </div>
    );
}
