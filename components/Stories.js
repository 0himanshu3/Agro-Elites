...
const stories = [
  {
    ...
    description:
      "Story of a farmer who increased profits by 30% using direct sales.",
  },
  {
...

  {
    ...
    description:
      "How government schemes helped a small farmer expand his business.",
  },
];
...
const Stories = () => {
  ...
  return (
    <div id="stories" className="bg-green-400 p-8 rounded-lg mt-8 m-4 relative">
      <h4 className="text-xl font-bold text-gray-900 mb-4 textalign">
        Success Stories
      </h4>
      <div className="bg-yellow-50 p-4 rounded-lg text-center relative">
        <button
        ...
        />
        <p className="text-white textblack">
